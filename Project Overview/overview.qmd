...
To use geospatial analysis to analyze the spatial characteristics of Singapore's parking lots and

Our application enables users to derive insights from Point pattern analysis using Spatial Patterns Analysis. It is helpful in uncovering whether the input data will be in regular, or clustered patterns or randomly distributed; or whether the distributions of data are dependent on each other. Colocation (tbc)
...
Colocation between HDB and HDB carparks .... HDB carparks with shopping malls

\<\<\< Need to change the problem\>\>\>Geospatial analysis can help identify hot spots and cold spots of car parks, which are areas with high and low concentrations of car parks, respectively. Understanding these patterns can inform policies and decisions related to the allocation and management of car park facilities, such as identifying areas in need of additional car parks or adjusting parking rates in areas with high demand.
...
### Spatial Point Patterns Analysis & Local Colocation Quotients (LCLQ) 
...
|                             |                                                     |
|                             | -   Various Kernel Methods (except for LCLQ)        |
|                             |                                                     |
|                             | -   Various Statistical Functions (except for LCLQ) |
+-----------------------------+-----------------------------------------------------+
...
-   Use spatial weight ....evaluates if a given observation's subcategory in A is colocated with subcategories in B.
